  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-secondary': 'linear-gradient(135deg, #60a5fa, #c084fc)',
        'gradient-accent': 'linear-gradient(135deg, #14b8a6, #3b82f6)',
        'gradient-hero': 'linear-gradient(135deg, #eff6ff, #f0f9ff)',
        'gradient-soft': 'linear-gradient(135deg, #ffffff, #f8fafc)',
      },
      boxShadow: {
